...
const PLATFORM_PREVIEW = {
  Instagram: { handle: "riversidebooks" },
  TikTok: { handle: "@riversidebooks" },
  X: { handle: "@riversidebooks" },
  Facebook: { handle: "Riverside Books" },
  Pinterest: { handle: "Riverside Books" },
};

const AVATAR_IMG = `<span class="composer-avatar"><img src="Design-files/Nav-Bar-Updated-Design/handoff/icons/icon-4.png" alt="Riverside Books" /></span>`;
