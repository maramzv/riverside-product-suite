...
function App() {
  ...
  return (
    <div className="app-shell">
      ...
      <header className="topbar"><a className="topbar-brand" href="#inventory"><img className="topbar-brand-icon" src="/brand/shelves/mark.png" alt="" /><span className="topbar-brand-text"><span className="topbar-brand-title">RIVERSIDE SHELVES</span><span className="topbar-brand-tagline">Inventory &amp; Preorders</span></span></a><nav><button className="header-link" type="button" onClick={showInventory}>Inventory</button><button type="button" onClick={scrollToAbout}>About</button></nav><button className="refresh" type="button" onClick={loadData}>Refresh data</button></header>
