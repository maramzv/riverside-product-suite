...
function App() {
  ...
  return (
    <div className="app-shell">
      ...
      <header className="topbar"><a className="brand" href="#inventory"><img src="/brand/shelves/header-wordmark.png" alt="Riverside Shelves — Inventory & Preorders" style={{ height: '40px', width: 'auto', objectFit: 'contain' }} /></a><nav><button className="header-link" type="button" onClick={showInventory}>Inventory</button><button type="button" onClick={scrollToAbout}>About</button></nav><button className="refresh" type="button" onClick={loadData}>Refresh data</button></header>
